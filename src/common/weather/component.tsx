...
class WeatherComponent extends PureComponent<Props, State> {
  state = {
  ...
  async componentDidMount() {
    ...
    const selectedLocation: string | undefined = await getCurrentPosition();
  ...
  handleGetWeather = async (
    ...
    const currentWeather:
      ...
      | undefined = await getWeather(cityName, weatherSource);
  ...
  handleChangeWeatherSource = (e: { target: { value: string } }): void => {
    const { value } = e.target;
